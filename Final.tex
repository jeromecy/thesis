...
\input{Chapters/01Intro/Introduction_Final}
\clearemptydoublepage

\chapter{Adaptive Smoothing V-Spline for Trajectory Reconstruction}\label{ChapterTS}
\input{Chapters/02TractorSplineTheory/TractorSplineTheory_Final}
...
\input{Chapters/05MCMCOU/MCMCEstimation_Final}
\clearemptydoublepage
...
\input{Appendices/AppendixTractorSpline_Final}
 ...
 \chapter{A Spin-off Outcome: Data Simplification Method}\label{appendSimp}
  \input{Chapters/06Spinoff/GPSsimp_Final}
