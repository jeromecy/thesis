...
The \textit{TracMap} company, located in New Zealand and USA, produces GPS display units to aid precision farming in agriculture, horticulture and viticulture. Operational data is collected and sent by these units to a remote server for further analysis. Generally, this data is irregularly sampled every 1 to 30 seconds over the whole day. 
...
\begin{tikzpicture}
     ...
     \end{scope}
\end{tikzpicture}
\caption{Examples of GPS data. Observed position is augmented with velocity information and other operating characteristics.}
\label{tracoverview}
\end{figure}
