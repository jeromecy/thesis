...
Compared with MH and Gibbs sampling, the HMC has a higher efficiency in most high-dimensional cases. It is incorporating not only with energy $U(x)$ but also with gradient. In this way, HMC explores a larger area and converges to balance faster. 
