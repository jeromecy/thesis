...
linear interpolation. Apparently, sharp turnings occur at joint knots. A smooth path is expected and more common in real life application. A piecewise polynomial is a function $p(t) = p_n^m(t)$ on $[a,b]$ defined with the aid of $n$ knots: $-\infty \leq a <t_1 <\cdots <t_n<b\leq +\infty$. 
