...
J[f]= \frac{1}{n} \sum_{i=1}^{n} \left( f(t_i)-y_i \right)^2 + \frac{\gamma}{n} \sum_{i=1}^{n} \left( f'(t_i)-v_i \right)^2 +\sum_{i=0}^{n} \int_{t_i}^{t_{i+1}}\lambda(t)  f''^2(t)dt,
\end{equation}
...
J[f]_{\gamma=0}= \frac{1}{n} \sum_{i=1}^{n} \left(f(t_i)-y_i\right)^2 +\sum_{i=0}^{n} \int_{t_i}^{t_{i+1}}\lambda(t) f''^2 dt,
\end{equation}
and
