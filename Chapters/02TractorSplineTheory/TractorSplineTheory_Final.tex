...
Suppose in a traditional least squares fitting, $ B_\xi$ is $N \times M$ matrix of $M$ cubic-spline basis functions evaluated at the $N$ training points $x_i$, with knot sequence $\xi$ and $M \ll N$. Thus the vector of fitted spline values is given by
...
%$\hat{\theta}=\left(B^\top B+\gamma C^\top C+n\Omega_\lambda\right)^{-1}\left(B^\top\mathbf{y}+\gamma C^\top\mathbf{v}\right)$ 
%with which one can obtain the following equations 
%\small %\begin{equation}
%\begin{split}
%  \mathbf{\hat{f}}&=B\hat{\theta}=B\left(B^\top B+\gamma C^\top C+n\Omega_\lambda\right)^{-1}B^\top\mathbf{y}+B\left(B^\top B+\gamma C^\top C+n\Omega_\lambda\right)^{-1} C^\top\mathbf{v}\\&=S\mathbf{y}+\gamma T\mathbf{v},
% \end{split}
% \end{equation}
% \begin{equation}
% \begin{split}
% \mathbf{\hat{f}}'&=C\hat{\theta}=C\left(B^\top B+\gamma C^\top C+n\Omega_\lambda\right)^{-1}B^\top\mathbf{y}+C\left(B^\top B+\gamma C^\top C+n\Omega_\lambda\right)^{-1}C^\top \mathbf{v}\\&=U\mathbf{y}+\gamma V\mathbf{v}.
 %\end{split}
%\end{equation}\normalsize
...
\centering
    \begin{subfigure}{0.45\textwidth}
%\includegraphics[width=\textwidth]{Chapters/02TractorSplineTheory/plot/ggplot/gg512Points2.pdf}
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=\textwidth]{Chapters/02TractorSplineTheory/plot/ggplot/gg512Points2.pdf}};
\begin{scope}[
x={(image.south east)},
y={(image.north west)}
]
...
\end{scope}
\end{tikzpicture}\caption{Original positions}\label{gg512Points}
\end{subfigure}%
%================%================
\begin{subfigure}{0.45\textwidth}
%\includegraphics[width=\textwidth]{Chapters/02TractorSplineTheory/plot/ggplot/gg512Path2.pdf}
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=\textwidth]{Chapters/02TractorSplineTheory/plot/ggplot/gg512Path2.pdf}};
\begin{scope}[
x={(image.south east)},
y={(image.north west)}
]
...
\node [black, font=\bfseries,rotate=90] at (0,0.5) {Northing};
\end{scope}
\end{tikzpicture}\caption{Line-based trajectory}\label{gg512Path}
\end{subfigure}
%================%================
\begin{subfigure}{0.45\textwidth}
%    \includegraphics[width=\textwidth]{Chapters/02TractorSplineTheory/plot/ggplot/gg512PointsX2.pdf}
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=\textwidth]{Chapters/02TractorSplineTheory/plot/ggplot/gg512PointsX2.pdf}};
\begin{scope}[
x={(image.south east)},
y={(image.north west)}
]
\node [black, font=\bfseries] at (0.5,-0.05) {$t$};
\node [black, font=\bfseries,rotate=90] at (0,0.5) {Easting};
\end{scope}
\end{tikzpicture}\caption{Original positions on easting direction ($x$-axis)}\label{gg512PointsX}
\end{subfigure}
%================%================
\begin{subfigure}{0.45\textwidth}
%\includegraphics[width=\textwidth]{Chapters/02TractorSplineTheory/plot/ggplot/gg512PointsY2.pdf}
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=\textwidth]{Chapters/02TractorSplineTheory/plot/ggplot/gg512PointsY2.pdf}};
\begin{scope}[
x={(image.south east)},
y={(image.north west)}
]
...
\node [black, font=\bfseries,rotate=90] at (0,0.5) {Northing};
\end{scope}
\end{tikzpicture}\caption{Original positions on northing direction ($y$-axis)}\label{gg512PointsY}
\end{subfigure}
%===============%================
...
%    \end{subfigure}
    ...
    \centering
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.45\textwidth]{Chapters/02TractorSplineTheory/plot/ggplot/ggRealdataXPenaltyPath3.pdf}};
\begin{scope}[
x={(image.south east)},
y={(image.north west)}
]
...
\end{tikzpicture} 
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.45\textwidth]{Chapters/02TractorSplineTheory/plot/ggplot/ggRealdataYPenaltyPath3.pdf}};
\begin{scope}[
x={(image.south east)},
y={(image.north west)}
]
...
\begin{figure}[h!]
  \centering
%%\includegraphics[width=\textwidth,height=10cm]{Chapters/02TractorSplineTheory/plot/ggplot/ggRealdataCombinedXY3.pdf}
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.9\textwidth]{Chapters/02TractorSplineTheory/plot/ggplot/ggRealdataCombinedXY3.pdf}};
\begin{scope}[
x={(image.south east)},
y={(image.north west)}
]
\node [black, font=\bfseries] at (0.5,-0.01) {Easting};
\node [black, font=\bfseries,rotate=90] at (0,0.5) {Northing};
\end{scope}
\end{tikzpicture} 
...
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.45\textwidth]{Chapters/02TractorSplineTheory/plot/ggplot/ggRealdataXYPenaltyPathofX3.pdf}};
\begin{scope}[
x={(image.south east)},
y={(image.north west)}
]
...
\end{tikzpicture}
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.45\textwidth]{Chapters/02TractorSplineTheory/plot/ggplot/ggRealdataXYPenaltyPathofY3.pdf}};
\begin{scope}[
x={(image.south east)},
y={(image.north west)}
]
...
\end{scope}
\end{tikzpicture}
     %%\includegraphics[width=0.45\linewidth]{Chapters/02TractorSplineTheory/plot/ggplot/ggRealdataXYPenaltyPathofX3.pdf}
     %%\includegraphics[width=0.45\linewidth]{Chapters/02TractorSplineTheory/plot/ggplot/ggRealdataXYPenaltyPathofY3.pdf}
\caption{2-dimensional reconstruction on easting ($x$) and northing ($y$) directions separately.}
\end{subfigure}  
\begin{subfigure}{\textwidth}
     \centering
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.9\textwidth]{Chapters/02TractorSplineTheory/plot/ggplot/ggRealdataXYPenaltyPathofXY3.pdf}};
\begin{scope}[
x={(image.south east)},
y={(image.north west)}
]
\node [black, font=\bfseries] at (0.5,-0.02) {Easting};
\node [black, font=\bfseries,rotate=90] at (0,0.5) {Northing};
\end{scope}
\end{tikzpicture}
     %%\includegraphics[width=0.9\linewidth]{Chapters/02TractorSplineTheory/plot/ggplot/ggRealdataXYPenaltyPathofXY3.pdf}
\caption{Combined 2-dimensional reconstruction.}
\end{subfigure}
...
The following Figure \ref{complete2DXY} is a complete reconstruction from the whole observed data set $\left\lbrace x,u,y,v\right\rbrace$. The overall reconstruction gives a smoothing path that goes through each measurement and avoids curvatures at turning points. 
...
\centering
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.9\textwidth]{Chapters/02TractorSplineTheory/plot/ggplot/ggRealdataCompleteXY2.pdf}};
\begin{scope}[
x={(image.south east)},
y={(image.north west)}
]
