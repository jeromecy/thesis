...
The TracMap company, located in New Zealand and USA, uses GPS display units for precision farming in agriculture, horticulture, viticulture and aviation. The GPS units guide the drivers to the right paddock, orchard or specific row that require maintenance, showing them where the hazards are on the way. Besides, the operation data is collected and sent back to a remote server by the these units. 
