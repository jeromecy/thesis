...
For a Tractor spline and its MSE function, there are two parameters $\lambda$ and $\gamma$ that are need to be estimated for. As a result, the objective function (\ref{originalcv}) becomes
\begin{align}
